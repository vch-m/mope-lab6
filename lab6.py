...
print("f(x1, x2, x3) = 7,8+9,6*x1+8,7*x2+3,1*x3+0,3*x1*x1+0,1*x2*x2+7,3*x3*x3+4,6*x1*x2+0,9*x1*x3+5,7*x2*x3+5,4*x1*x2*x3")
...
Y1 = [round(7.8 + 9.6*X1[i] + 8.7*X2[i] + 3.1*X3[i] + 0.3*X1kv[i] + 0.1*X2kv[i] + 7.3*X3kv[i]+ 4.6*X12[i] + 0.9*X13[i] + 5.7*X23[i] + 4.5*X123[i] + random.randrange(-10 ,10)-5,3) for i in range(15)]
Y2 = [round(7.8 + 9.6*X1[i] + 8.7*X2[i] + 3.1*X3[i] + 0.3*X1kv[i] + 0.1*X2kv[i] + 7.3*X3kv[i]+ 4.6*X12[i] + 0.9*X13[i] + 5.7*X23[i] + 4.5*X123[i] + random.randrange(-10 ,10)-5,3) for i in range(15)]
Y3 = [round(7.8 + 9.6*X1[i] + 8.7*X2[i] + 3.1*X3[i] + 0.3*X1kv[i] + 0.1*X2kv[i] + 7.3*X3kv[i]+ 4.6*X12[i] + 0.9*X13[i] + 5.7*X23[i] + 4.5*X123[i] + random.randrange(-10 ,10)-5,3) for i in range(15)]
